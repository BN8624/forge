...
Forge가 기존 세계관을 5권 126개 장면의 장편 구조로 확장하고 critic 독립 검증 뒤 정본으로 승격했다. 산문은 정본 순서대로 19개 장면까지 생성·승인됐다.
...
1. `python pipeline\generate_prose.py --all`로 남은 장면을 정본 순서대로 생성한다.
